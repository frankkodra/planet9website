					          ...
					          <div class="address-area">
					              ...
					              <div class="address-list">
					                  ...
					                  <div class="info-content">
					                      ...
					                      <em><a href="mailto:info@Planet9.com">Info@Planet9.com</a></em>
					                  </div>
					              </div>
					              <div class="address-list">
					                  <div class="info-icon">
			    ...
			    <div class="row no-gutters">
			    	<div class="col-lg-4">
			    		<div class="contact-map">
			    		    <iframe src="https://maps.google.com/maps?q=Houston&t=&z=13&ie=UTF8&iwloc=&output=embed"></iframe>
			    		</div>
			    	</div>
			        <div class="col-lg-4">
			                ...
			                <div class="col-lg-4 col-md-6 md-mb-30">
			                   <div class="contact-box">
			                       ...
			                       <div class="content-text">
			                           ...
			                           <p class="services-txt"> Houston, Info<br> Link Rd, Texas</p>
			                       </div>
			                   </div>
			                </div>
			                <div class="col-lg-4 col-md-6 sm-mb-30">
			                   <div class="contact-box">
			                       ...
			                       <div class="content-text">
			                           ...
			                           <span><a href="mailto:Planet9@info.com">Planet9@info.com</a></span><br>
			                           <span><a href="mailto:Planet9@info.com">Planet9@info.com</a></span>
			                       </div>
			                   </div>
			                </div>
			    ...
			    <div class="container">               
			        <div class="partner-content-widget">
			        	<div class="rs-carousel owl-carousel" 
			        	    ...
			        	    <div class="logo-img">
			        	        <a href="#">
			        	            <img class="hovers-logos rs-grid-img" src="assets\images\productIcons\mango stacked crooked no back ground clr.png" title="" alt="">
			        	            <img class="mains-logos rs-grid-img " src="assets\images\productIcons\mango stacked crooked no back ground noclr.png" title="" alt="">
			        	        </a>
			        	    </div>
			        	    <div class="logo-img">
			        	        <a href="#">
