							   ...
							   <div class="col-lg-7">
									<div class="toolbar-contact">
										<ul class="rs-contact-info">                   
											<li>
					                            ...
					                            <a href="mailto:info@konstruk.com">info@Planet9.com</a>               
					                        </li>
	                                        <li>
								...
								<div class="col-lg-5">
									<div class="toolbar-sl-share">
										<ul class="clearfix">
											<li class="opening"> <em><i class="fi fi-rr-time-add"></i> Hours: Mon-Fri: 9.00 am - 6.00 pm</em> </li>
											...
											<nav class="rs-menu hidden-md">
												<ul class="nav-menu">
													...
													<li class="menu-item-has-children">
														...
														<ul class="sub-menu">
															<li><a href="lyftoffbrownies.html">Lyft Off 500mg Brownies</a></li>
															<li><a href="elgallomix.html">El Gallo Mix</a></li>
															<li class="last-item menu-item-has-children">
															    <a href="cannagar.html">Virginia-rolled Cannagar</a>
															</li>
														</ul>
													</li>
													<li>
								...
								<div class="col-cell">
									<div class="expand-btn-inner">
										<ul>
                                            ...
                                            <li class="btn-quote"><a class="quote-button" href="#">Find a product and Lyft Off!</a></li>
											<li class="humburger">
					    ...
					    <ul class="nav-menu">
					    	...
					    	<li class="menu-item-has-children">
					    		...
					    		<ul class="sub-menu">
					    			<li><a href="lyftoffbrownies.html">Lyft Off 500mg Brownies</a></li>
					    			<li><a href="elgallomix.html">El Gallo Mix</a></li>
									<li><a href="cannagar.html">Virginia-rolled Cannagar</a></li>
					          ...
					          <div class="address-area">
					              ...
					              <div class="address-list">
					                  ...
					                  <div class="info-content">
					                      ...
					                      <em><a href="mailto:info@konstruk.com">Info@Planet9.com</a></em>
					                  </div>
					              </div>
					              <div class="address-list">
					                  <div class="info-icon">
			...
			<div class="rs-breadcrumbs img1">
			    <div class="container">
			        <div class="breadcrumbs-inner">
			            ...
			            <span class="sub-text">With Over 5 Years of Industry Experience, Our Shop Offers a Safe Haven for THC and Delta-8 Enthusiasts. Explore a Clean Environment and In-Depth Product Guidance to Find Your Ideal Cannabis Experience.</span>
			            <ul class="breadcrumbs-area">
                           <li title="Go to Planet 9">
				...
				<div class="container">
					<div class="row y-middle">
						<div class="col-lg-6 md-mb-50">
							<div class="images-part blacknwhite">
								<img src="assets/images/about/style1/bgtest.jpg" alt="About">
							</div>
						</div>
						<div class="col-lg-6 pl-50 md-pl-15">
							<div class="sec-title">
								<span class="sub-text">
									<img src="assets/images/planet 9 logo temporary.png" height="28px" width="25px" alt="Images">
									Who We Are
								</span>
								<h2 class="title pb-20">
									Discover Planet 9 From Cosmic Cowboys Extractions!
								</h2>
								<p class="desc pb-37">
									Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed commodo 
									venenatis magna, eu tincidunt ipsum interdum ut. Fusce vel aliquam nunc. 
									Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Phasellus vel arcu enim.
								</p>
								<div class="row y-middle">
									<div class="col-lg-4 col-md-4 sm-mb-30 ">
										<div class="about-img">
											<img src="assets/images/planet 9 logo temporary.png" alt="About">
										</div>
									</div>
									<div class="centerRespon col-lg-8 col-md-8">
										<ul class="check-lists">
				        					<li class="list-item">
												<span class="icon-list-icon">
													<i class="fa fa-check-circle"></i>						
												</span>
												<span class="list-text">Lab Tested</span>
											</li>
											<li class="list-item">
												<span class="icon-list-icon">
													<i class="fa fa-check-circle"></i>						
												</span>
												<span class="list-text">Pesticide and Residue-free</span>
											</li>
											<li class="list-item">
												<span class="icon-list-icon">
													<i class="fa fa-check-circle"></i>						
												</span>
												<span class="list-text">Locally sourced and cultivated</span>
											</li>
				        				</ul>
									</div>
								</div>
								<div class="row mt-47 md-mt-25">
									<div  class="col-lg-6 col-md-4 sm-mb-30">
										<div class="centerRespon btn-part">
	                ...
	                <div class="row y-middle">
	                	<div class="col-lg-6 pr-60 md-pr-15 mt-40 md-mb-40">
		                    ...
		                    <div class="cl-skill-bar">
		                        <!-- Start Skill Bar -->
		                        <span class="skillbar-title">Delta-8 Product Variety</span>
		                        <div class="skillbar" data-percent="85">
		                            <p class="skillbar-bar"></p>
		                            <span class="skill-bar-percent">85%</span> 
		                        </div> 
		                        <!-- Start Skill Bar -->
		                        <span class="skillbar-title">Customer Satisfaction Rate:</span>
		                        <div class="skillbar" data-percent="99">
		                            <p class="skillbar-bar"></p>
		                            <span class="skill-bar-percent">99%</span> 
		                        </div> 
		                        <!-- Start Skill Bar -->
		                        <span class="skillbar-title">States Supplied</span>
		                        <div class="skillbar" data-percent="75">
		                            <p class="skillbar-bar"></p>
		                            <span class="skill-bar-percent">75%</span> 
		                        </div> 
		                        <!-- Start Skill Bar -->
		                        <span class="skillbar-title">Community Engagement Impact</span>
						...
						<div class="col-lg-6 video-img">
							<div class="rs-videos">
								<div class="animate-border">
	                                <a class="popup-border popup-videos" href="https://www.youtube.com/watch?v=Y_plhk1FUQA">
	   	    			...
	   	    			<div class="contact-box-item">
				    		<div class="contact-box mb-20">
			                    ...
			                    <div class="content-text">
			                        <h4 class="title"><a href="#">Our Texas Location</a></h4>
			                        <p class="services-txt">9876 Street,<br> Houston, TX 77953 USA</p>
			                    </div>
			                </div>
			                <div class="contact-box mb-20">
			                    <div class="contact-icon">
			                    ...
			                    <div class="content-text">
			                        ...
			                        <p class="services-txt">
			                        	<a href="mailto:test@gamil.com"> info@Planet9</a><br>
			                        </p>
			                    </div>
			                </div>
			                <div class="contact-box">
			                    ...
			                    <div class="content-text">
			                        ...
			                        <p class="services-txt">
			                        	<a href="tel:(+088)589-8745">(+1) 8824-353-232</a><br>
			                        	<a href="tel:(+088)222-9999">(+1) 7854-333-272</a>
			                        </p>
			                    </div>
			                </div>
	   	    			</div>
