						...
						<div class="container">
							<div class="row-table">
								<div class="col-cell header-logo">                                  
								    <div class="logo-area">
								        <a href="index.html">
								            <img class="normal-logo" src="assets/images/planet 9 logo temporary.png" alt="logo">  
								            <img class="sticky-logo" src="assets/images/planet 9 logo temporary.png" alt="logo">
								        </a>
								    </div>
								</div>
								<div class="col-cell">
												...
												<ul class="nav-menu">
													...
													<li class="menu-item-has-children">
														...
														<ul class="sub-menu">
															...
															<li><a href="elgallomix.html">El Gallo Mix Candy</a></li>
															<li><a href="mangoshot.html">Delta-8 Mango Shot</a></li>
															<li class="last-item menu-item-has-children">
															    <a href="cannagar.html">Cannagar</a>
															</li>
														</ul>
													</li>
													<li>
								...
								<div class="col-cell">
									<div class="expand-btn-inner">
										<ul>
                                            ...
                                            <li class="btn-quote"><a class="quote-button" href="#">Find a Product and Lyft Off!k</a></li>
											<li class="humburger">
					    ...
					    <ul class="nav-menu">
					    	...
					    	<li class="menu-item-has-children">
					    		...
					    		<ul class="sub-menu">
					    			...
					    			<li><a href="elgallomix.html">El Gallo Mix Candy</a></li>
									<li><a href="mangoshot.html">Delta-8 Mango Shot</a></li>
									<li><a href="cannagar.html">Cannagar</a></li>
					          ...
					          <div class="address-area">
					              ...
					              <div class="address-list">
					                  ...
					                  <div class="info-content">
					                      ...
					                      <em><a href="mailto:info@Planet9.com">Info@email.com</a></em>
					                  </div>
					              </div>
					              <div class="address-list">
					                  <div class="info-icon">
			...
			<div class="rs-breadcrumbs img2">
			    <div class="container">
			        <div class="breadcrumbs-inner">
			            ...
			            <span class="sub-text">Savor the pure taste of sun-ripened mangoes in our 100% all-natural juice, now infused with delta-8 for a quick, relaxed high.<br> 
							Experience the perfect blend of tropical flavors and mild euphoria in every sip. </span>
			        </div>
			    </div>
			</div>
			<!-- Breadcrumbs End -->
					...
					<div class="row y-middle">
						<div class="col-lg-6 md-mb-50">
							<div class="single-img">
								...
								<div class="arrow left" onclick="navigateLightbox(-1)">←</div>
						...
						<div class="col-lg-6">
		                	<div class="sec-title mt-30 pl-30 md-pl-15">
								<h2 class="title title4 ser-style5 pb-30">Delta-8 Mango Shot</h2>
								<p class="margin-0 pb-25">
									Indulge in the pure taste of sun-ripened mangoes with our 100% all-natural mango juice, now enhanced with delta-8 for a quick-acting, relaxed high, offering a blissful escape in every sip. Experience the perfect fusion of tropical flavors and mild euphoria with our meticulously crafted delta-8 infused mango juice.
								</p>
								<ul class="prodInfo">
									<li>100mg-200mg per unit</li>
									<li>MUST BE REFRIGERATED</li>
									<li>Enjoy Within: 4-5 months</li>
								</ul>
								<div class="priceSection">
									<span id="price">$10</span><span class="discount"> 20%</span>
								  </div>
								<div class="oldPrice">
									$12.50
								</div>
								<div class="btn-list grid">
									<div class="number-box">
										<input class="inputNumber" type="number" id="quantityInput" value="0" min="0">
									  </div>
									<div class="dropdown">
										<button class="dropbtn">Price Options</button>
										<div class="dropdown-content" id="priceOptions">
										  <div class="column">
											<div onclick="changePrice('retail')">Retail</div>
											<span>$10</span>
										  </div>
										  <div class="column">
											<div onclick="changePrice('wholesale')">Wholesale</div>
											<span>$5 - MOQ 10</span>
										  </div>
										</div>
									  </div>
							...
							<div class="col-xl-3 col-md-6 md-40">
								<div class="process-item process-gap">
									...
									<div class="number-text">
	                                    ...
	                                    <h3 class="number-title">Rolling</h3>
